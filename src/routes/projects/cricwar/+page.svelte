...
<div class="page">
	...
	<h1 class="story-title font-bodoni">CricWAR</h1>
	<p class="story-meta font-garamond">Cricket Analytics · Statistical Modelling</p>

	<div class="under-construction">
		<p class="uc-label font-garamond">Under Construction</p>
		<p class="uc-sub font-garamond">The full product story for CricWAR is being written. Check back soon.</p>
	</div>
	...
	<nav class="social-row" aria-label="Links">
		...
		<a class="social-item" href="https://github.com/abetrs/cricket-sim" target="_blank" rel="noopener noreferrer">
