	...
	let experiences = $state([
		{
			...
			current: false,
			description:
				'Scaled deal flow and shaped investment strategy for a venture capital firm, focusing on integrating AI into the VC lifecycle and developing strategic partnerships.',
			skills: [
				'LLM Engineering',
				'Due Diligence',
				'Strategic Planning',
		...
		},
		{
			...
			projects: ['Product opportunity brief development', 'Decision pack standardization framework']
		},
		{
			...
			current: false,
			description:
				'Led end-to-end UX design for lithium-ion battery supply chain solutions, conducting user research and developing design systems for enterprise IT solutions.',
			skills: [
				'UX Design',
				'User Research',
				'Figma',
...
<div bind:this={pageContainer} class="w-full max-w-[900px] space-y-12">
	...
	<div class="mt-16 space-y-8 text-center">
		<div class="font-mono text-sm text-gray-500">Continue scrolling to explore my projects</div>
