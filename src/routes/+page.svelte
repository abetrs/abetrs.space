...
>
	<img
		...
		alt="Abhayprad Jha profile photo"
...
<div class="w-full max-w-[771px]">
	<div class="text-justify">
		<h2 class="font-condensed mb-4 text-[32px] font-bold tracking-[-1.92px] text-black">
			About Me
		</h2>
...
<div bind:this={pageContainer} class="mt-16 space-y-8 text-center">
	<div class="font-mono text-sm text-gray-500">Scroll down to explore more about my journey</div>
