			...
			<div class="space-y-8 text-left">
				<div class="rounded-lg bg-white p-6 shadow-sm">
					...
					<div class="text-[18px] text-gray-700">
						<p class="mb-4">
							Exploring the intersection of technology and business through a rigorous dual-degree program 
							that combines technical problem-solving with economic analysis and strategic thinking.
						</p>
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div>
								<h4 class="font-semibold mb-2">Computer Science</h4>
							...
							<div>
								<h4 class="font-semibold mb-2">Economics</h4>
								<ul class="space-y-1 text-[16px]">
									<li>• Econometrics</li>
				...
				<div class="rounded-lg bg-white p-6 shadow-sm">
					...
					<div class="space-y-6">
						...
						<div class="border-l-4 border-blue-500 pl-4">
							<h4 class="text-[20px] font-semibold mb-2">William & Mary Cricket Club</h4>
							<p class="text-[16px] text-gray-600 mb-2">Captain and President • August 2024 - Present</p>
							<ul class="space-y-2 text-[16px] text-gray-700">
								<li>• Leading recruitment initiatives to promote cricket at William & Mary</li>
								<li>• Generated $1000+ in revenue through strategic fundraising and campus partnerships</li>
								<li>• Implemented travel policy for team members, generating $100+ in additional revenue</li>
								<li>• Collaborated with College Administration to secure professional protective equipment for 20+ team members</li>
						...
						<div class="border-l-4 border-green-500 pl-4">
							<h4 class="text-[20px] font-semibold mb-2">The Flat Hat (Student Newspaper)</h4>
							<p class="text-[16px] text-gray-600 mb-2">Data Editor • January 2023 - Present</p>
							<ul class="space-y-2 text-[16px] text-gray-700">
								<li>• Launched and scaled data journalism from 0 to 1, defining product vision and editorial processes</li>
								<li>• Grew section output to 20+ analytical articles annually</li>
								<li>• Led cross-functional team of 5+ writers to ship inaugural full-page feature</li>
								<li>• Expanded coverage to 2 full pages per semester through iterative improvements</li>
								<li>• Designed reusable data visualization components for Sports and News sections</li>
								<li>• Leveraged primary data collection and quantitative analysis to uncover student life insights</li>
							</ul>
						</div>

						<!-- International Mini Market -->
						<div class="border-l-4 border-purple-500 pl-4">
							<h4 class="text-[20px] font-semibold mb-2">International Mini Market</h4>
							<p class="text-[16px] text-gray-600 mb-2">Organizer • May 2023 - April 2024</p>
							<ul class="space-y-2 text-[16px] text-gray-700">
								<li>• Managed end-to-end execution of campus pop-up retail featuring 50+ international products</li>
								<li>• Coordinated with 15+ multicultural organizations for product sourcing and logistics</li>
								<li>• Achieved 100% sell-through rate within 2 hours, validating product-market fit</li>
						...
						<div class="border-l-4 border-orange-500 pl-4">
							<h4 class="text-[20px] font-semibold mb-2">South Asian Student Association</h4>
							<p class="text-[16px] text-gray-600 mb-2">Outreach Chair • May 2023 - April 2024</p>
							<ul class="space-y-2 text-[16px] text-gray-700">
								<li>• Represented South Asian students and promoted cultural awareness across campus</li>
