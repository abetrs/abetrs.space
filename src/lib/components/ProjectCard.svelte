<script>
	...
	let { title, description, tech = [], demoUrl = null, githubUrl = null, index = 0, projectId = null, hasStory = false } = $props();
		...
		<div class="p-6">
			...
			{#if hasAnyActions}
				<div class="flex gap-2 pt-2 flex-wrap">
					...
					{#if githubUrl}
						<button
							class="font-condensed rounded-lg bg-black px-3 py-2 text-[14px] text-white transition-colors duration-200 hover:bg-gray-800 flex-shrink-0 flex items-center gap-2"
